...
public class Valecnik extends Bojovnik {
    ...
    public double getPravdepodobnostKrit() {
        return pravdepodobnostKrit;
    }
    ...
    public String utoc(Bojovnik protivnik) {
        if (Math.random() <= this.pravdepodobnostKrit) {//udelím kritik
    ...
    public String toString() {
        return super.toString()+ " krit=" + pravdepodobnostKrit+" ";
    }
